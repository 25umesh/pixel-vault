...
class StegoApp(tk.Tk):
    ...
    def create_widgets(self):
        tk.Label(self.button_frame, text="Image Steganography",
    ...
    def show_info(self):
        ...
        create_table(scroll_container,
            ...
            [
            ["S.Gnaneshwar", "ST#IS#7552", "gnaneshwar010@gmail.com"],
            ["N.Saishoumik Reddy", "ST#IS#7539", "shoumik098@gmail.com"],
            ["M.Akshay", "ST#IS#7547", "akshaykumargoud@gmail.com"],
            ["manoj pal", "ST#IS#7550", "manojpal@gmail.com"],
            ],
            col_weights=[3, 1, 3]
        )
        ...
        create_table(scroll_container,
            ...
            [
                ...
                ["Company Address", "Supraja Technologies Pvt.Ltd."]
            ],
            col_weights=[1, 3]
        )
...
if __name__ == "__main__":
    ...
    gif_path = r"C:\Users\GNANESHWAR\Desktop\speed blur GIF by Chris Gannon.gif"
    fg_image_path = r"C:\Users\GNANESHWAR\Desktop\hello.jpg"
